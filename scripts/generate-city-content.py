...
{{
  "heroTagline": "{short}エリアの民泊運営・清掃をエリアに精通したチームが（この形式は維持しつつ、都市の特色を活かした表現にすること・30字以内）",
  "heroCopy": "（都市の魅力を凝縮したキャッチコピー・20字以内・「〜を。」形式）",
  "heroSubcopy": "（民泊オーナー向けに{short}の地域特性・ゲスト層・季節需要・当社サービスの強みを盛り込んだ説明文・100〜150字）",
  "localRules": [
    {{
      "icon": "（Font Awesomeのfasアイコンクラス名・fa-で始まる）",
      "title": "（{short}固有の民泊運営ルール・課題・タイトル・20字以内）",
      "body": "（具体的な説明・60〜80字）",
      "highlight": "（3〜6字のキーワードラベル）"
    }},
    {{
      "icon": "（Font Awesomeのfasアイコンクラス名）",
      "title": "（{short}のゲスト層・需要特性に関するルール・20字以内）",
      "body": "（具体的な説明・60〜80字）",
      "highlight": "（3〜6字のキーワードラベル）"
    }},
    {{
      "icon": "（Font Awesomeのfasアイコンクラス名）",
      "title": "（{short}の季節性・繁閑対策に関するルール・20字以内）",
      "body": "（具体的な説明・60〜80字）",
      "highlight": "（3〜6字のキーワードラベル）"
    }}
  ],
  "cleaningFeature": {{
    "title": "（{short}の地域特性に合わせた清掃の特徴タイトル・25字以内）",
    "body": "（{short}特有の清掃上の工夫・注意点・80〜100字）"
  }},
  "seoTitle": "{short}の民泊 運営代行・清掃代行 | Minpaku Resort（この形式を維持）",
  "seoDescription": "（{short}（{pref_name}）の民泊オーナー向け。地域固有のキーワードを含む自然な説明文・110〜130字）"
}}
"""
